  ...
  return (
    <section className='page-section page-section--pink'>
      <div className='wrapper'>
        ...
        <p>
          In my communication arsenal, I have a Twitter, a GitHub account, a cell phone and an email address. I'll just leave those here in both icons and a regular list. <em>And...</em> that's pretty much it for here.
        </p>
          <div className='my-contacts section group'>
            <ul className='col span_2_of_3'>
              <li>Twitter: <a target='_blank' href='https://twitter.com/doubleAM2'>@doubleAM</a></li>
              <li>Github:  <a target='_blank' href='https://github.com/amci1203'>amci203</a></li>
            ...
            <div className='col span_1_of_3'>
              <div className='social-icons text-center-force'>
                ...
                <a href='mailto:me@allen-mcintoshii.com' className='social-icons__icon'>
                  <img src='img/mail.svg' className='icon mail' />
                </a>
                <a href='tel:12424413229' className='social-icons__icon'>
