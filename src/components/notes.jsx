  ...
  return (
    <section className='page-section'>
      <div className='wrapper'>
        <a name='notes' />
        <h1 className='section-title'>Final Notes</h1>
        <p>
        ...
        <p>
          If you'd like some direct links to any of my projects, you can check out my website. I have a section there for that purpose <a href='http://allen-mcintoshii.com#projects' target='_blank'>here</a>
        </p>
        <p>
