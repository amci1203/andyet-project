    ...
    return (
      <section id='about'>
        <div className='page-section wrapper'>
          ...
          <p>
          My full name is Allen Alexander McIntosh II. I was born and raised in The Bahamas on the capital island of New Providence (know to everyone as Nassau). I enjoy playing video games, a nice game or ten of basketball, and I love dearly and dislike objectively. I started taking programming seriously only a year ago now. Before then, I learnt HTML & CSS and tried a dash of Javascript, but I didn't really try to do anything. I also learnt Java in school too, but wasn't interested in doing anything that wasn't my homework. It was only after I decided to leave school (and by extension my girlfriend's physical company) and went back home that I decided that I decided to really buckle down and put my game face on--my, how time flies. I have a hard time believing it's only been that long when I think about all the stuff I've learnt in that time.
          </p>
          <p>
